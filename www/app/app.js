angular.module("eliteApp", ["ionic", "angular-data.DSCacheFactory", 'ngAnimate', 'ngSanitize', 'ui.bootstrap', 'google-maps'])
...
.run(function($ionicPlatform, DSCacheFactory) {
    ...
    DSCacheFactory("surveyDataCache", { storageMode: "localStorage", maxAge: 720000, deleteOnExpire: "aggressive" });
    DSCacheFactory("surveysCache", { storageMode: "localStorage", maxAge: 720000, deleteOnExpire: "aggressive" });
})
.config(function($stateProvider, $urlRouterProvider) {
    ...
    .state('home.surveys', {
        ...
        views: {
            "tab-surveys": {
                templateUrl: "app/home/surveys.html"
            }
        }
    })
    ...
    .state('app.survey-details', {
        ...
        views: {
            'mainContent': {
                templateUrl: "app/surveys/survey-details.html"
            }
        }
    })
